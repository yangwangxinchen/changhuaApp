MakerJS.distributionRoom=function(){
    ...
    //获取各型号电柜
    function getCabinet(){
        low_p01= engine.scene.getObjectByName("低压柜003")
        low_m01= low_p01.material
        low_p02= engine.scene.getObjectByName("低压柜1")
        low_m02= low_p02.material
        high_p03= engine.scene.getObjectByName("高压柜1")
        high_m03= high_p03.material
        high_p04= engine.scene.getObjectByName("高压柜2")
        high_m04= high_p04.material
        change_p05=engine.scene.getObjectByName("变压器")
